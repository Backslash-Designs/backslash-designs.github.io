      ...
      <Box sx={{ maxWidth: 900, mx: "auto" }}>
        ...
        <Box
          sx={{
            ...
            "& p": { mb: 1.25, opacity: 0.95 },
            "& ul, & ol": { pl: 3, mb: 1.25 },
            "& a": { color: "primary.main" },
            "& hr": { my: 2, borderColor: (t) => t.palette.divider },
            "& code": {
              fontFamily:
        ...
        >
          ...
          <ul>
            ...
            <li>
              ...
              to Backslash Designs, 275 Amelia St East Thunder Bay, ON P7E 3Z6.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Backslash Designs, accessible from{" "}
              <a href="https://www.backslashdesigns.ca/" target="_blank" rel="noopener noreferrer">
                https://www.backslashdesigns.ca/
              </a>
            </li>
            <li>
          ...
          <h4 style={{ fontWeight: 700, marginTop: 8, marginBottom: 4 }}>Personal Data</h4>
          <p>
          ...
          <h4 style={{ fontWeight: 700, marginTop: 8, marginBottom: 4 }}>Usage Data</h4>
          ...
          <h4 style={{ fontWeight: 700, marginTop: 8, marginBottom: 4 }}>Tracking Technologies and Cookies</h4>
          <p>
          ...
          <ul>
            <li>
              ...
              <br />
              <strong>Purpose:</strong> These Cookies are essential to provide You with services available through the
              Website and to enable You to use some of its features. They help to authenticate users and prevent
            ...
            <li>
              ...
              <strong>Administered by:</strong> Us
              <br />
              <strong>Purpose:</strong> These Cookies allow us to remember choices You make when You use the Website, such
              as remembering your login details or language preference. The purpose of these Cookies is to provide You with
          ...
          <ul>
            ...
            <li>
              ...
              services and events which We offer that are similar to those that you have already purchased or inquired
          ...
          <h4 style={{ fontWeight: 700, marginTop: 8, marginBottom: 4 }}>Business Transactions</h4>
          <p>
          ...
          <h4 style={{ fontWeight: 700, marginTop: 8, marginBottom: 4 }}>Law enforcement</h4>
          <p>
          ...
          <h4 style={{ fontWeight: 700, marginTop: 8, marginBottom: 4 }}>Other legal requirements</h4>
          ...
          <ul>
            <li>
              ...
              <a href="https://www.backslashdesigns.ca/privacy" target="_blank" rel="noopener noreferrer">
                https://www.backslashdesigns.ca/privacy
              </a>
            </li>
          </ul>
        </Box>
